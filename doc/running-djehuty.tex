...
\subsubsection{The \t{sram} configuration}
  ...
  When using SURF Research Access Management (SRAM) as identity provider,
  \t{djehuty} can persuade SRAM to send an invitation for the service that
  this instance of \t{djehuty} provides.  To do so, the following attributes
  must be configured.
